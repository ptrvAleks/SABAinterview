...
### 3. Параллельный шлюз (**Parallel Gateway (AND)**)
...
### 4. Событийный шлюз (**Event Gateway**)
...
- Дорожка (**Lane**) — подразделение или роль в Pool'е
...
- [Другие виды элементов BPMN](https://stormbpmn.com/bpmn/elements)
- [Подробнее про виды BPMN](https://bpmn20.ru/docs/docly-documentation/obzor-vseh-vidov-diagramm-bpmn/)